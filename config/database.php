    ...
    */
    ...
    'connections' => [
        ...
        'adminDB' => [
            ...
            'collation' => env('ADMIN_DB_COLLATION', 'utf8_unicode_ci'),
            'prefix'    => env('ADMIN_DB_PREFIX', ''),
            'timezone'  => env('ADMIN_DB_TIMEZONE', '+00:00'),
            'strict'    => env('ADMIN_DB_STRICT_MODE', false),
        ],
        ...
        'clientDB' => [
            ...
            'username'  => null,
            'password'  => null,
            'charset'   => env('DB_STRICT_MODE', 'utf8'),
        ],
